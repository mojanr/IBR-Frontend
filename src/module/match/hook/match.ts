import { AppApiError, AppApiResponseWithPagination } from "@/core/lib/api"
import { keepPreviousData, useQuery } from "@tanstack/react-query"
import { getMatch } from "../service/match"
...
export const useGetMatch = (eventId: number | string, enabled?: boolean) => {
  ...
  const query = useQuery<AppApiResponseWithPagination<any>, AppApiError<any>>({
    queryKey: ["table-index-match", eventId],
