...
import { useGetLicense } from "../../hook/license";
import { AiOutlineLoading3Quarters } from "react-icons/ai";

const FieldLicense = <Field extends TField>({ control, name, label, required, tooltip, ...props }: FieldSelectProps<Field>) => {

  // use query get license
  const { data, isLoading, isFetching, isError, error } = useGetLicense()
