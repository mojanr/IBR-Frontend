...
import { z } from "zod";
import { useEditUser, useUpdateUser } from "../../hook/user";
...
export type formEditUserSchemaType = z.infer<typeof formEditUserSchema>

type FormEditUserProps = {
  defaultValues: any
}

const FormEditUser = ({ defaultValues }: FormEditUserProps) => {

  // use notification
  const { notification } = App.useApp()

  // use create user
  const { mutate, isPending, isError, error } = useUpdateUser(defaultValues.id)
